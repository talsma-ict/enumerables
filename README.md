...
The `Enumerable` class is **very** similar to a standard Java `Enum` type.  
However, it has one special feature that makes it more suitable for using in an API you are maintaining.
